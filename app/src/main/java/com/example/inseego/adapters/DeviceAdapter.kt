...
class DeviceAdapter(Group_List: ArrayList<Devices>?, _Context: Context) :
    RecyclerView.Adapter<DeviceAdapter.ViewHolder>() {

    var group_list: ArrayList<Devices>? = null
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val item = group_list!![position].cameragroup_name
